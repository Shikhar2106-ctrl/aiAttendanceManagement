...
def  teacher_screen_login():
    ...
    st.space()
    st.space()
    teacher_username= st.text_input("Enter username", placeholder="Username", key='teacher_username')
    teacher_password= st.text_input("Enter password", placeholder="Password", type='password', key='teacher_password')
